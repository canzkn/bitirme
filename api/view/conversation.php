...
// conversation operations control
if(!$param[1])
{
    include "view/conversation/get.php";
}
elseif ($param[1] && (file_exists("view/conversation/". $param[1] . ".php")))
{
    include "view/conversation/". $param[1] . ".php";
}
else
{

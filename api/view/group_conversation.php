<?php
/**
 * Group Conversation Operations API.
...
// group conversation operations control
if(!$param[1])
{
    include "view/group_conversation/get.php";
}
elseif ($param[1] && (file_exists("view/group_conversation/". $param[1] . ".php")))
{
    include "view/group_conversation/". $param[1] . ".php";
}
else
{
